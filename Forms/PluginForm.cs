...
namespace DspAudio.Vst.Forms
{
	...
	partial class PluginForm : Form
	{
		...
		{
			InitializeComponent();
			WindowsInterop.WindowsTheme.HandleTheme(this.PluginParameterListVw);
			WindowsInterop.WindowsTheme.HandleTheme(this.PluginPropertyListVw);
		}

		public VstPlugin PluginContext { get; set; }
